...
ifeq ($(config),debug)
TARGETDIR = bin/Debug-linux-x86_64/msdfgen
TARGET = $(TARGETDIR)/libmsdfgen.a
OBJDIR = bin-int/Debug-linux-x86_64/msdfgen
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -g -std=c++17
LIBS += bin/Debug-linux-x86_64/freetype/libfreetype.a
LDDEPS += bin/Debug-linux-x86_64/freetype/libfreetype.a
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64

else ifeq ($(config),release)
TARGETDIR = bin/Release-linux-x86_64/msdfgen
TARGET = $(TARGETDIR)/libmsdfgen.a
OBJDIR = bin-int/Release-linux-x86_64/msdfgen
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -std=c++17
LIBS += bin/Release-linux-x86_64/freetype/libfreetype.a
LDDEPS += bin/Release-linux-x86_64/freetype/libfreetype.a
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -s

else ifeq ($(config),dist)
TARGETDIR = bin/Dist-linux-x86_64/msdfgen
TARGET = $(TARGETDIR)/libmsdfgen.a
OBJDIR = bin-int/Dist-linux-x86_64/msdfgen
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -std=c++17
LIBS += bin/Dist-linux-x86_64/freetype/libfreetype.a
LDDEPS += bin/Dist-linux-x86_64/freetype/libfreetype.a
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -s
